...
#             elif message[0] == pb_msg1:
#                 button_state2 = message[1]
#                 if button_state2 == 1:
#                 print(f"Push Button 2 State: {button_state2}")

# Example Usage (Modify this for your specific robot)
joint_ids = [0, 1, 2, 3, 5, 6, 7, 8, 9, 10, 12, 13, 14, 15, 16, 17, 18, 19, 20]   
joint_angles = [55, 25, 2, 5, 70, 55, 20, 94, 65, 75, 110, 115, 60, 100, 63, 0, 70, 65, 65]
