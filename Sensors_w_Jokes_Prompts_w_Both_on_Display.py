...
prompts_dataset = pd.read_csv(r"C:\Users\Jorge\Desktop\engr_285\Clog_Bot\JOKE_BOT\prompts.csv")
...
jokes_dataset = pd.read_csv(r"C:\Users\Jorge\Desktop\engr_285\Clog_Bot\JOKE_BOT\jokes.csv", encoding='utf-8')
...
def read_serial_message():
    ...
    with open("phrase_log_080824.txt", "a") as log_file:
        if ser.in_waiting > 0:
